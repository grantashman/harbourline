...
assert.doesNotMatch(index, /account-status|Account · On/, "the static shell must not add a duplicate account status; the account panel owns the functional control");
