...
| Five-bill activation | Staging | Add income and five regular bills through onboarding | The first payday plan opens and the aggregate activation event is recorded without financial values | — | Not run |
